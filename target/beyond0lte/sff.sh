...
# SEC Floating Feature configuration file for Galaxy S10e (beyond0lte)
...
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_PUNCHHOLE_VI=face,pos:0.9037:0.0307,size:0.1148:0.0614,type:circle

# Fingerprint sensor
SEC_FLOATING_FEATURE_BIOAUTH_CONFIG_FINGERPRINT_FEATURES=capacitive_powerkey_phone

# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy S10e
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMG970F
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 9 V; 1.67 A
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_beyond0_exynos9820
