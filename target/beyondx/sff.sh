...
# SEC Floating Feature configuration file for Galaxy S10 5G (beyondx)
...
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_PUNCHHOLE_VI=face,pos:0.8176:0.0281,size:0.2546:0.0571,type:bx

# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy S10 5G
...
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_beyondx_exynos9820
