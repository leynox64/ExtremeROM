...
# SEC Floating Feature configuration file for Galaxy S21+ (t2s)
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMG996B
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 9 V; 2.77 A
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_t2s_exynos2100
