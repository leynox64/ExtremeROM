...
# SEC Floating Feature configuration file for Galaxy S20 Ultra (z3s)
...
# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy S20 Ultra
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMG988B
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 10 V; 4.5 A
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_z3s_exynos9830
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_SWLENS_DISTORTION_CORRECTION=hubble3,S5K3P9
